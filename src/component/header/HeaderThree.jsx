...
import { FaInstagram, FaMusic ,FaYoutube , FaGithub } from "react-icons/fa";
...
class HeaderThree extends Component{
    ...
    render(){
        ...
        let logoUrl;
        if(logo === 'light'){
            logoUrl = <img src="/assets/images/logo/Logo_LT.png" alt="POWR Design Light" />;
        }else if(logo === 'dark'){
            logoUrl = <img src="/assets/images/logo/Logo_LT.png" alt="POWR Design Dark" />;
        }else if(logo === 'symbol-dark'){
            logoUrl = <img src="/assets/images/logo/Logo_LT.png" alt="POWR Design" />;
